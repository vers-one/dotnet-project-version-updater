...
const updater_1 = __importDefault(__nccwpck_require__(45));
async function run() {
    try {
...
var UpdateMode;
(function (UpdateMode) {
    UpdateMode[UpdateMode["BUMP_MAJOR_NUMBER"] = 0] = "BUMP_MAJOR_NUMBER";
    UpdateMode[UpdateMode["BUMP_MINOR_NUMBER"] = 1] = "BUMP_MINOR_NUMBER";
    UpdateMode[UpdateMode["BUMP_BUILD_NUMBER"] = 2] = "BUMP_BUILD_NUMBER";
    UpdateMode[UpdateMode["BUMP_REVISION_NUMBER"] = 3] = "BUMP_REVISION_NUMBER";
    UpdateMode[UpdateMode["SET_VERSION"] = 4] = "SET_VERSION";
})(UpdateMode || (UpdateMode = {}));
async function update(filePath, newVersion) {
    ...
    const updateMode = parseUpdateMode(newVersion);
...
function bumpVersion(oldVersion, updateMode) {
